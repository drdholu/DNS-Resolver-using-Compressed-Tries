...
function App() {
    ...
    const fetchTrieStructure = async () => {
        try {
            const response = await axios.get(`${API_BASE_URL}/trie`);
    ...
    return (
        <div className="flex flex-col justify-center items-center p-4 min-h-screen bg-gradient-to-b via-gray-900 to-gray-800 from-slate-900">
            <div className="p-6 w-full max-w-5xl rounded-xl border border-gray-700 shadow-2xl backdrop-blur-sm bg-gray-800/90">
                ...
                <div className="mb-8">
                    <div className="flex relative gap-2">
                        <div className="relative w-full group">
                            <div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg opacity-25 blur transition duration-200 group-hover:opacity-40"></div>
                            <input 
                                type="text" 
                                ...
                                className="relative px-4 py-3 w-full placeholder-gray-400 text-gray-100 rounded-lg border border-gray-600 bg-gray-700/90 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                            />
                        </div>
                        <button 
                            onClick={resolveDomain}
                            disabled={loading || !domain.trim()}
                            className="px-6 py-3 font-medium text-gray-100 bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg shadow-md transition-all duration-200 hover:from-blue-500 hover:to-purple-500 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-gray-800 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                            {loading ? (
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                    <div className="space-y-4">
                        {ip && (
                            <div className="p-4 rounded-lg border shadow-lg transition-all transform bg-gray-700/80 border-green-700/70">
                        ...
                        {error && (
                            <div className="p-4 rounded-lg border shadow-lg bg-gray-700/80 border-yellow-600/70">
                    ...
                    <div className="space-y-2">
                        <div className="flex justify-between items-center mb-2">
                            ...
                            <button 
                                ...
                                className="px-3 py-1 text-xs text-gray-300 bg-gray-700 rounded-full shadow-md transition-all transform hover:bg-gray-600 hover:scale-105 focus:outline-none focus:ring-1 focus:ring-purple-500"
                            >
